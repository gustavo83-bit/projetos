...
const numPairs = 9; // Define o número de pares de cartas. Para uma grade 6x6, temos 36 cartas no total, então 18 pares.
...
const cardImages = [
    ...
    './assets/img/img5.png', './assets/img/img6.png', './assets/img/img7.png', './assets/img/img8.png', './assets/img/img17.png'
];
...
function initializeGame() {
    ...
    cardsArray.forEach(card => {
        ...
        backFace.src = './assets/img/verso_carta.png';
